...
### Core Modules
- **Multi-Tenant Architecture** - Support for multiple retail stores with isolated data
...
│   ├── api/               # API routes for retail operations
│   ├── login/             # Authentication pages
│   ├── super-admin/       # Super admin dashboard
│   └── tenant/            # Retail store pages
...
### Super Admin
- Manage all retail tenants and plans
...
This codebase has been optimized for retail operations only:
- Removed manufacturer, factory, and distributor modules
- Simplified user types to Super Admin and Store Admin
